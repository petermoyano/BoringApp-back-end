...
VALUES ('Nasa', 'Nasa', 862,
       ...
       ('Apple', 'Apple', 698,
        ...
        '/logos/logo4.png'),
       ('Cysco systems', 'Cysco systems', 288,
        'Republican truth church generation voice price issue.',
        '/logos/logo1.png'),
       ('eventbrite', 'Eventbrite', 398,
...
VALUES ('Conservator, furniture', 110000, 0, 'Shopify'),
       ...
       ('Surveyor, building', 144000, 0, 'eventbrite'),
       ...
       ('Merchant navy officer', 106000, 0, 'Cysco systems'),
       ...
       ('Astronomer', 143000, NULL, 'Shopify'),
       ...
       ('Tree surgeon', NULL, 0.001, 'Invision'),
       ('Management consultant', 183000, 0, 'spotify'),
       ('Ergonomist', 160000, 0, 'Nasa'),
       ('Psychologist, forensic', 176000, 0, 'Apple'),
       ...
       ('Engineer, chemical', 81000, 0, 'eventbrite'),
       ...
       ('Bonds trader', NULL, NULL, 'Cysco systems'),
       ...
       ('Race relations officer', 97000, 0.065, 'Nasa'),
       ('Engineering geologist', 89000, 0.043, 'ayala-buchanan'),
       ('Aeronautical engineer', 135000, 0.078, 'Tesla'),
       ...
       ('Leisure centre manager', 135000, NULL, 'spotify'),
       ('Television production assistant', 99000, NULL, 'spotify'),
       ...
       ('Clinical cytogeneticist', 152000, 0.027, 'Cysco systems'),
       ('Nature conservation officer', 82000, 0.093, 'Shopify'),
       ('Insurance underwriter', NULL, 0.008, 'Invision'),
       ...
       ('Engineer, materials', 140000, 0.057, 'Cysco systems'),
       ('Product designer', 184000, 0.090, 'gillespie-smith'),
       ('Editor, film/video', 199000, 0.070, 'Nasa'),
       ...
       ('Quality manager', 138000, 0.002, 'eventbrite'),
       ('Radio producer', 99000, 0.038, 'Cysco systems'),
       ...
       ('Set designer', 132000, 0.055, 'eventbrite'),
       ('Accountant, chartered certified', 86000, 0.070, 'Apple'),
       ...
       ('Engineer, technical sales', 157000, 0.083, 'Microsoft'),
       ...
       ('Clinical biochemist', 92000, NULL, 'Tesla'),
       ...
       ('Medical physicist', 110000, 0.015, 'Cysco systems'),
